export default function InfoLogo() {
  return (
    <svg
      className="fill-current h-8 w-8 mr-4 flex-shrink-0 mt-1"
      id="Layer_1"
      height="512"
      viewBox="0 0 64 64"
      width="512"
    ...
    >
      <g>
        <g id="LINE_57_">
          <g>
            <path
              d="m31.99 44.904c-1.104 0-2-.896-2-2v-15.795c0-1.104.896-2 2-2s2 .896 2 2v15.795c0 1.105-.895 2-2 2z" />
          </g>
        </g>
        ...
        <g id="POINT_1_">
          <g>
            <path
              d="m31.99 23.11c-.53 0-1.04-.21-1.41-.59-.38-.37-.59-.88-.59-1.41s.21-1.04.59-1.41c.74-.75 2.08-.75 2.82-.01.38.38.59.89.59 1.42 0 .52-.21 1.04-.59 1.41-.37.38-.88.59-1.41.59z" />
          </g>
        </g>
